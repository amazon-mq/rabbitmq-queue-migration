...
public class TestConfiguration {
    ...
    private boolean enableTTL = false; // Enable TTL on queues (disabled by default to prevent migration issues)
    private boolean enableMaxLength = false; // Enable max length on queues (disabled by default to prevent migration issues)
    private boolean enableMaxPriority = false; // Enable priority on queues (disabled by default to prevent migration issues)
    ...
    public int getSmallMessageSize() { return smallMessageSize; }
    public void setSmallMessageSize(int smallMessageSize) { this.smallMessageSize = smallMessageSize; }

    public int getMediumMessageSize() { return mediumMessageSize; }
    public void setMediumMessageSize(int mediumMessageSize) { this.mediumMessageSize = mediumMessageSize; }

    public int getLargeMessageSize() { return largeMessageSize; }
    public void setLargeMessageSize(int largeMessageSize) { this.largeMessageSize = largeMessageSize; }

    public double getSmallMessagePercent() { return smallMessagePercent / 100.0; }
    public void setSmallMessagePercent(int smallMessagePercent) { this.smallMessagePercent = smallMessagePercent; }

    public double getMediumMessagePercent() { return mediumMessagePercent / 100.0; }
    public void setMediumMessagePercent(int mediumMessagePercent) { this.mediumMessagePercent = mediumMessagePercent; }

    public double getLargeMessagePercent() { return largeMessagePercent / 100.0; }
    public void setLargeMessagePercent(int largeMessagePercent) { this.largeMessagePercent = largeMessagePercent; }
    ...
    public void setMessageSizes(String sizes) {
        ...
        if (small < 8 || small > maxSize || medium < 8 || medium > maxSize || large < 8 || large > maxSize) {
    ...
    public boolean isEnableHA() { return enableHA; }
    public void setEnableHA(boolean enableHA) { this.enableHA = enableHA; }

    public String getHaPolicy() { return haPolicy; }
    public void setHaPolicy(String haPolicy) { this.haPolicy = haPolicy; }

    public boolean isEnableTTL() { return enableTTL; }
    public void setEnableTTL(boolean enableTTL) { this.enableTTL = enableTTL; }

    public boolean isEnableMaxLength() { return enableMaxLength; }
    public void setEnableMaxLength(boolean enableMaxLength) { this.enableMaxLength = enableMaxLength; }

    public boolean isEnableMaxPriority() { return enableMaxPriority; }
    public void setEnableMaxPriority(boolean enableMaxPriority) { this.enableMaxPriority = enableMaxPriority; }

    public long getTtlMilliseconds() { return ttlMilliseconds; }
    public void setTtlMilliseconds(long ttlMilliseconds) { this.ttlMilliseconds = ttlMilliseconds; }
    ...
    public void setExchangeCount(int exchangeCount) { this.exchangeCount = exchangeCount; }

    public int getBindingsPerQueue() { return bindingsPerQueue; }
    public void setBindingsPerQueue(int bindingsPerQueue) { this.bindingsPerQueue = bindingsPerQueue; }

    public int getConfirmationWindow() { return confirmationWindow; }
    ...
    public int getMigrationTimeout() { return migrationTimeout; }
    public void setMigrationTimeout(int migrationTimeout) { this.migrationTimeout = migrationTimeout; }

    public boolean isSkipCleanup() { return skipCleanup; }
    public void setSkipCleanup(boolean skipCleanup) { this.skipCleanup = skipCleanup; }
